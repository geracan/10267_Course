...
<div class="customerTable">
    ...
    <div class="customerTableRow">
        ...
        <div class="customerTableRightCol">
            <asp:DropDownList ID="CustomerCountryDropDownList" runat="server" DataSourceID="CountriesSqlDataSource"
...
<asp:SqlDataSource ID="CountriesSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:CustomerManagementConnectionString %>"
