<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Customer.ascx.vb" Inherits="Customer"
    ClassName="Customer" %>
<div class="customerTable">
    ...
    <div class="customerTableRow">
        ...
        <div class="customerTableRightCol">
            <asp:DropDownList ID="CustomerCountryDropDownList" runat="server" DataSourceID="CountriesSqlDataSource" DataValueField="ID" DataTextField="Name">
            </asp:DropDownList>
    ...
    <div class="customerTableRow">
        ...
        <div class="customerTableRightCol">
            ...
            <asp:RequiredFieldValidator ID="CustomerCreditLimitRequiredFieldValidator" ControlToValidate="CustomerCreditLimitTextBox"
                runat="server" ErrorMessage="The Credit Limit must be filled in." Text="*" Display="Dynamic"></asp:RequiredFieldValidator>
    ...
    <div class="customerTableFooter">
        ...
        &nbsp;<asp:Button ID="CustomerCancelButton" runat="server" Text="Cancel" CausesValidation="false" />
    </div>
</div>
