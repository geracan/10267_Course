<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Customers.aspx.vb" Inherits="Services_Customers" %>
...
<body>
    ...
    <div>
        ...
        <asp:RequiredFieldValidator ID="StartingLettersRequiredFieldValidator" runat="server"
            ControlToValidate="StartingLettersTextBox" Display="Dynamic" ErrorMessage="The text box must contain at least one character."></asp:RequiredFieldValidator>
        &nbsp;
        <asp:Button ID="GetCountriesButton" runat="server" Text="Get Countries" />
        <br />
