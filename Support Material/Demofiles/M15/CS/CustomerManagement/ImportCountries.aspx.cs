...
public partial class ImportCountries : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (System.Web.Configuration.WebConfigurationManager.AppSettings["EnableSaveImportedCountries"] != null)
        {
            // Get enable save countries value from configuration file
            bool enableSaveCountries = (bool)
                (System.Web.Configuration.WebConfigurationManager.AppSettings["EnableSaveImportedCountries"].ToLower() == "true");
